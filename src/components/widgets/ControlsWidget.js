...
const ControlsWidget = ({
  ...
  return (
    ...
    >
      ...
      >
        <span className="flex w-2/3 duration-200 sm:group-hover/widget:w-full sm:hover:-translate-y-1">
          {mute ? <Mic /> : <MicOff />}
        </span>
      </div>
      ...
      >
        <SwitchCamera className="flex w-2/3 duration-200 sm:group-hover/widget:w-full" />
      </div>
    </div>
  );
};
